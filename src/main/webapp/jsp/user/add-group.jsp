 ...
 <div class="container" >
 	<div class="pagetitle">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"> <fmt:message key="breadcrumbs.list"/></li>
        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              <div class="card mb-3">
                <div class="card-body">
                    <h5 class="card-title text-center pb-0 fs-4"><fmt:message key="breadcrumbs.group"/></h5>
                    <p class="text-center small"><fmt:message key="groupe.informations"/></p>
                  <form  class="row g-3 needs-validation">
                    <div class="col-md-6">
                        <label for="name" class="form-label"><fmt:message key="group.name"/></label>
                     	 <div class="input-group has-validation">
                        <input type="text" id="name" name="name" class="form-control" />
                      <div class="invalid-feedback"><fmt:message key="group.invalid.feedback"/></div>
                      </div>
                    </div>
                    <div class="col-md-6">
                       <label for="description" class="form-label"><fmt:message key="group.description"/></label>
                      <div class="input-group has-validation">
                         <textarea  id="description" name="description" class="form-control" placeholder="<fmt:message key="group.placeholder"/>"></textarea>
                      </div>
                    </div>
                    ...
                    <div class="col-md-3">
                      <input type="button" data-bs-toggle="modal" id="create-btn" onclick="loadPage('/group/list-groups'); addGroupe()" class="btn btn-primary w-100"  value="<fmt:message key="bnt.save"/>"/>
                     </div>
