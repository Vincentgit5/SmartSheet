	...
	<div class="pagetitle">
		<nav>
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active"><fmt:message key="breadcrumbs.role" /></li>
			</ol>
		</nav>
	</div>
	...
	<section class="section">
		<div class="row">
			<div class="col-lg-12">
				<div class="card">
					<div class="card-body">
						<h5 class="card-title"><fmt:message key="role.list" /></h5>
						<div class="datatable-wrapper no-footer">
							<div class="datatable-container">
								<table class="datatable-table table datatable striped-rows">
									<thead>
										<tr>
											<th scope="col"><fmt:message key="role.number" /></th>
											<th scope="col"><fmt:message key="role.name" /></th>
											<th scope="col"><fmt:message key="role.description" /></th>
											<th scope="col"><fmt:message key="role.date" /></th>
											<th scope="col"><fmt:message key="role.action" /></th>
										</tr>
									</thead>
									<tbody>
