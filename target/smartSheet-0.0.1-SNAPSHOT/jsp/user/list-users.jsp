              ...
              <table class="table datatable">
                ...
                <c:forEach var="user" items="${users}" varStatus="loop">
                  <tr class="${loop.index % 2 == 0 ? 'even-row' : 'odd-row'} bonjour">
                    <th>
				      <img src="/download/${user.imagePath}" class="rounded-circle">
				    </th>
                    <td>${user.username}</td>
                    <td>${user.email}</td>
                    <td>${user.address}</td>
                    ...
                    <td>
                      ...
                      <button class="button-edite" onclick="loadPage('user/viewUser/${user.username}')"><i class="fas fa-pencil-alt"></i></button>
				      <button class="button-delete" data-bs-target="#areyouSureYouWantToDetele" id="startDeleting" data-bs-toggle="modal"><i class="fas fa-trash-alt"></i></button>
                    </td>
                  </tr>
		           ...
		           <div class="modal-dialog modal-dialog-centered">
		             <div class="modal-content">
		               ...
		               <div class="modal-foote">
	                      ...
	                      <button type="button" onclick="removeUser('${user.id}')"  data-bs-toggle="modal" class="btn btn-danger">Yes</button>
	                    </div>
		             </div>
		           </div>
		          </div>
