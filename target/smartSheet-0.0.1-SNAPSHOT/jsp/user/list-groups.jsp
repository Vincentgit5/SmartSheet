                ...
                <tbody> 
	                <c:forEach items="${groups}" var="group" varStatus="loop">
	                  <tr class="${loop.index % 2 == 0 ? 'even-row' : 'odd-row'}">
	                    ...
	                    <td>
                     	  <button class="button-see" onclick="loadPage('group/group-details/${group.name}')"><i class="fas fa-eye"></i></button>
	                      <button class="button-icon"  onclick="confirm_decision('${group.name}')"><i class="fas fa-pencil-alt"></i></button>
